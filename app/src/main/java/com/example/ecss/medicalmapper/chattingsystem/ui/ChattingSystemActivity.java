package com.example.ecss.medicalmapper.chattingsystem.ui;
...
import com.example.ecss.medicalmapper.chattingsystem.adapter.UsersChatAdapter;
import com.example.ecss.medicalmapper.chattingsystem.login.LogInActivity;
import com.example.ecss.medicalmapper.chattingsystem.model.User;
import com.example.ecss.medicalmapper.chattingsystem.register.RegisterActivity;
...
public class ChattingSystemActivity extends Activity {

    private static String TAG = ChattingSystemActivity.class.getSimpleName();
    ...
    public static DatabaseReference mUserRefDatabase;
    ...
    public static void startActivity(Context context) {
        ...
        context.startActivity(new Intent(context, ChattingSystemActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattingsystem);

        /*if (getIntent() != null && getIntent().getExtras() != null && getIntent().getExtras().getParcelable("IntentObject") != null) {
            UserFromIntent user = getIntent().getExtras().getParcelable("IntentObject");
