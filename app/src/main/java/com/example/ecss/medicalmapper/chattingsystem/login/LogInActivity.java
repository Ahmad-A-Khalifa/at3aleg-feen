package com.example.ecss.medicalmapper.chattingsystem.login;
...
import com.example.ecss.medicalmapper.chattingsystem.FireChatHelper.ChatHelper;
...
public class LogInActivity extends Activity {
    ...
    private void goToMainActivity() {
        Intent intent = new Intent(LogInActivity.this, ChattingSystemActivity.class);
